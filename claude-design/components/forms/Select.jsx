...
export function Select({ options, value, onChange, disabled, placeholder = "Select…" }) {
  ...
  return (
    <div ref={ref} style={{ position: "relative", display: "inline-block", width: 200, fontFamily: "var(--font-body)" }}>
      <button
        type="button"
        disabled={disabled}
        onClick={() => setOpen((o) => !o)}
